...
%In Figure \ref{fig:M33Rot}, it can be seen that the circular velocity beyond a certain point (around 3 kpc) seems to decrease as time passes, which is indicative of the loss of M33's mass during its orbit. This agrees with my earlier hypothesis that the phase diagram would have a lower velocity at further radii than initially.%
