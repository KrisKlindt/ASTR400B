...
for i in range(9):
    plt.plot(RR_RCs[i][0], RR_RCs[i][1], label = f"Time = {times[i]:.2f} (Gyrs)")

plt.vlines(3, 0, 120, linestyles="dotted", colors="k")

# Add axis labels and title
plt.title("M33's Analytical Rotation Curve Evolution", fontsize = 30)
