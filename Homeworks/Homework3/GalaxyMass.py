...
LGHaloMass = MWHaloMass+M31HaloMass+M33HaloMass # calculates halo/dark matter mass of local group
print(LGBaryonMass/LGHaloMass) # print f_bar of local group