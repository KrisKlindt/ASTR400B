...
plt.semilogy(zrange+1, EDeSitter.Temperature(zrange), linewidth=5, label='Einstein-DeSitter')
...
# What is the size of sound horizon at the epoch of recombination in BenchMark Cosmology? 
SoundHorizon = BenchMark.SoundHorizon(z_recombine, 20000)
print(SoundHorizon)

# What is the sound horizon TODAY in the BenchMark Cosmology?

# Proper Distance = Comving Radial Distance / (1+z)
