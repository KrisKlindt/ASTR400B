...
filename2 = "./IsochroneData/Isochrone7.txt"
filename3 = "./IsochroneData/Isochrone10.txt"
filename4 = "./IsochroneData/Isochrone11.txt"
filename5 = "./IsochroneData/Isochrone13_5.txt"
...
plt.plot(data2['B']-data2['R'], data2['R'], color='r', linewidth=5, label='~7 Gyr')
plt.plot(data3['B']-data3['R'], data3['R'], color='purple', linewidth=5, label='~10 Gyr')
plt.plot(data4['B']-data4['R'], data4['R'], color='black', linewidth=5, label='~11 Gyr')
plt.plot(data5['B']-data5['R'], data5['R'], color='green', linewidth=5, label='~13.5 Gyr')
...
"""
Galaxy mergers, supernovas from previous generation of stars provide new material
