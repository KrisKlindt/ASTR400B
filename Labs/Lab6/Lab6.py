...
def sersicE(r, re, n, mtot):
    ...
    # break down the sercic profile
    a = (r/re)**(1/n)
    b = -7.67*(a-1)
    
    # the surface brightness or mass density
    I= Ie*np.exp(b)
...
# Sersic Index = 4
SercicM31Bulge = sersicE(r_annuli, re_bulge, 4, bulge_total)
...
# YOU ADD HERE
ax.loglog(r_annuli, sigmaM31Bulge, linewidth=2, label = "Sim Bulge")


# Sersic fit to the surface brightness Sersic fit
# YOU ADD HERE
ax.loglog(r_annuli, SercicM31Bulge/1e10, linestyle = '-.', lw = 3, label = "Sercic n=4")
