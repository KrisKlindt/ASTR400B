...
# ADD HERE
ax.semilogy(mk, schechter_M(mk, alpha=-1.35), color = 'r', linewidth=5,
            linestyle = ':', label= r'high $\alpha$')

ax.semilogy(mk, schechter_M(mk, alpha=-0.6), color = 'black', linewidth=5,
            linestyle = '--', label= r'low $\alpha$')
...
# 5000 Msun cluster - how much mass is between 1 and 120 Msun
